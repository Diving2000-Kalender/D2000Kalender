...
<br /><br />
	...
	<div class="style_form">
	  ...
	  <input type="text" name="mobil" class="form_element" value="<?php echo "" . getMobileFromEVE($_SESSION["eveID"]) . ""; ?>">
	</div>

	<div class="style_form">
	  <label for="fastnet">Fastnet:</label>
	  <input type="text" name="fastnet" class="form_element" value="<?php echo "" . getFastnetFromEVE($_SESSION["eveID"]) . ""; ?>">
	</div>
...
<div class="style_form">
  ...
  <input type="text" name="mobilE" value="<?php echo "" . getAMobileFromEVE($_SESSION["eveID"]) . ""; ?>" class="form_element">
</div>
